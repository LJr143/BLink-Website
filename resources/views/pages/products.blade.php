...
<body class="products-page-body admin-mode">
      ...
      <div class="product-item">
        <div class="product-card">
          <div class="admin-controls">
            <button class="btn-admin edit" onclick="openProductModal()"><i
  ...
  <div id="adminModal" class="modal-overlay">
    <div class="modal-content">
      ...
      <div class="decor-settings">
        ...
        <div class="input-row">
          <div><label>Sticker Width (px)</label><input type="number" value="120"></div>
          <div><label>Sticker Height Offset (px)</label><input type="number" value="-20"></div>
        </div>
      </div>
  ...
  <script>
    ...
    function openProductModal() { document.getElementById('adminModal').style.display = 'flex'; }
